...
namespace ShowingAds.AndroidApp.Core
{
    public static class Settings
    {
        ...
        public static readonly Uri ServerPath = new Uri("http://84.38.188.128:3700/");
        //public static readonly Uri ServerPath = new Uri("http://192.168.0.5:49160/");
        ...
        public static readonly Uri FilesServicePath = new Uri("http://31.184.219.123:4000/");
        public static readonly Uri NotifyPath = new Uri("http://84.38.188.128:3680/device/");
        ...
        public static DriveInfo GetDownloadDriveInfo()
        {
            var fileInfo = new FileInfo(GetVideoFilesPath(string.Empty));
            var drivers = DriveInfo.GetDrives();
            foreach (var driver in drivers)
                if (fileInfo.FullName.Contains(driver.RootDirectory.FullName))
                    return driver;
            return drivers[0];
        }
    }
